# 1 "mcc_generated_files/application/MCP9844_temp_sensor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/application/MCP9844_temp_sensor.c" 2
# 27 "mcc_generated_files/application/MCP9844_temp_sensor.c"
# 1 "mcc_generated_files/application/MCP9844_temp_sensor.h" 1
# 30 "mcc_generated_files/application/MCP9844_temp_sensor.h"
...
# 31 "mcc_generated_files/application/MCP9844_temp_sensor.h" 2
...
# 28 "mcc_generated_files/application/MCP9844_temp_sensor.c" 2
...
# 56 "mcc_generated_files/application/../drivers/.././i2c1_master.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c99\\stdbool.h" 1 3
# 57 "mcc_generated_files/application/../drivers/.././i2c1_master.h" 2
...
# 36 "mcc_generated_files/application/../drivers/i2c_simple_master.h" 2
...
# 29 "mcc_generated_files/application/MCP9844_temp_sensor.c" 2
# 58 "mcc_generated_files/application/MCP9844_temp_sensor.c"
static int16_t MCP9844_CalcTemperature(void);

uint16_t MCP9844_GetManufacture(void)
{
    return i2c_read2ByteRegister((0x18), (0x06));
}

uint16_t MCP9844_GetDevice(void)
{
    return i2c_read2ByteRegister((0x18), (0x07));
}
...
static int16_t MCP9844_CalcTemperature(void)
{
    ...
    temperatureData = i2c_read2ByteRegister((0x18), (0x05));
    upperByte = ((temperatureData & (0xFF00)) >> 8) & (0x1F);
